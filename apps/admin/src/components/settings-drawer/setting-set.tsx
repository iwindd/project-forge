...
export default function SettingSet({
  ...
  return (
    <Box className={classes.root} style={{ '--setting-set-offset': `${offset}px` } as SettingSetStyle} p='lg' pt='xl'>
      <Group className={classes.header} px={8} py={4} gap={4}>
        ...
        {information && (
          <Tooltip label={information} withArrow>
            <Box component='span' tabIndex={0} role='img' aria-label={information} className={classes.info}>
