...
import { profileResponseSchema, profileUpdateResponseSchema } from '@/servers/profile/schemas';
...
export const profileApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    updateProfile: builder.mutation<z.infer<typeof profileUpdateResponseSchema>, ProfileUpdateInput>({
      query: (input) => ({
        url: 'profile',
        method: 'PATCH',
...
export const { useGetProfileQuery, useDisconnectConnectionMutation, useUpdateProfileMutation } = profileApi;
