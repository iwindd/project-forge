...
describe('admin profile mutation flows', () => {
  ...
  it.each([
    ...
    [
      'details',
      ProfileDetailsForm,
      { bio: 'New bio', timezone: 'Asia/Bangkok' },
      profileMutationResult('Ada', 'New bio', 'Asia/Bangkok'),
      'บันทึกข้อมูลโปรไฟล์สำเร็จ',
    ],
  ])(
    'shows success and updates profile state for a successful %s mutation',
    async (_label, component, values, result, success) => {
