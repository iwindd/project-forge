...
export function AppBreadcrumbs({ currentLabel, withHiddenRoots = false }: AppBreadcrumbsProps) {
  const fullTrail = useActiveRouteTrail();
  const trail = withHiddenRoots ? fullTrail : fullTrail.filter((route) => !route.hiddenBreadcrumb);
